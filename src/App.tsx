...
const contract_id = {
  ...
  txId: "c1108d14dd3da67fe610327433372485667d757aa174f762feccf2041b00873e",
  /** The output index */
  outputIndex: 0,
};
    ...
    <div className="App">
      ...
      >
        <Table>
          <TableHead>
            <TableRow>
              <TableCell align="center">Lucy</TableCell>
              <TableCell align="center">Lucy</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
              ...
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"Lucy"}
                    src={`${process.env.PUBLIC_URL}/${"Lucy1"}.png`}
                  />
                </Box>
              </TableCell>
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"Lucy"}
                    src={`${process.env.PUBLIC_URL}/${"Lucy"}.png`}
                  />
                </Box>
              </TableCell>
            </TableRow>
